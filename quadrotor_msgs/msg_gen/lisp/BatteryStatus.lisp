...
(cl:defmethod cl:initialize-instance :after ((m <BatteryStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quadrotor_msgs-msg:<BatteryStatus> is deprecated: use quadrotor_msgs-msg:BatteryStatus instead.")))
...
(cl:defmethod current-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:current-val is deprecated.  Use quadrotor_msgs-msg:current instead.")
  (current m))
