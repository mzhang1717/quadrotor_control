...
;//! \htmlinclude AircraftStateMsg.msg.html

(cl:defclass <AircraftStateMsg> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass AircraftStateMsg (<AircraftStateMsg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <AircraftStateMsg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'AircraftStateMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_estimation-msg:<AircraftStateMsg> is deprecated: use state_estimation-msg:AircraftStateMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AircraftStateMsg>))
...
(cl:defmethod position-val ((m <AircraftStateMsg>))
...
(cl:defmethod rotation-val ((m <AircraftStateMsg>))
...
(cl:defmethod velocity-val ((m <AircraftStateMsg>))
...
(cl:defmethod accel_bias-val ((m <AircraftStateMsg>))
...
(cl:defmethod gyro_bias-val ((m <AircraftStateMsg>))
...
(cl:ensure-generic-function 'rot_r-val :lambda-list '(m))
(cl:defmethod rot_r-val ((m <AircraftStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimation-msg:rot_r-val is deprecated.  Use state_estimation-msg:rot_r instead.")
  (rot_r m))

(cl:ensure-generic-function 'pos_c-val :lambda-list '(m))
(cl:defmethod pos_c-val ((m <AircraftStateMsg>))
...
(cl:defmethod rot_c-val ((m <AircraftStateMsg>))
...
(cl:defmethod covariance-val ((m <AircraftStateMsg>))
  ...
  (covariance m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <AircraftStateMsg>) ostream)
  "Serializes a message object of type '<AircraftStateMsg>"
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'rot_r) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AircraftStateMsg>) istream)
  "Deserializes a message object of type '<AircraftStateMsg>"
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'rot_r) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AircraftStateMsg>)))
  "Returns string type for a message object of type '<AircraftStateMsg>"
  "state_estimation/AircraftStateMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AircraftStateMsg)))
  "Returns string type for a message object of type 'AircraftStateMsg"
  "state_estimation/AircraftStateMsg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AircraftStateMsg>)))
  "Returns md5sum for a message object of type '<AircraftStateMsg>"
  "19fe8d0ddf5f5d1aa6a6e23d9e7097ac")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AircraftStateMsg)))
  "Returns md5sum for a message object of type 'AircraftStateMsg"
  "19fe8d0ddf5f5d1aa6a6e23d9e7097ac")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AircraftStateMsg>)))
  "Returns full string definition for message of type '<AircraftStateMsg>"
  (cl:format cl:nil "Header header~%geometry_msgs/Point position~%geometry_msgs/Quaternion rotation~%geometry_msgs/Vector3 velocity~%geometry_msgs/Vector3 accel_bias~%geometry_msgs/Vector3 gyro_bias~%geometry_msgs/Quaternion rot_r~%geometry_msgs/Point pos_c~%geometry_msgs/Quaternion rot_c~%float64[] covariance~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AircraftStateMsg)))
  "Returns full string definition for message of type 'AircraftStateMsg"
  (cl:format cl:nil "Header header~%geometry_msgs/Point position~%geometry_msgs/Quaternion rotation~%geometry_msgs/Vector3 velocity~%geometry_msgs/Vector3 accel_bias~%geometry_msgs/Vector3 gyro_bias~%geometry_msgs/Quaternion rot_r~%geometry_msgs/Point pos_c~%geometry_msgs/Quaternion rot_c~%float64[] covariance~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <AircraftStateMsg>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'rot_r))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <AircraftStateMsg>))
  "Converts a ROS message object to a list"
  (cl:list 'AircraftStateMsg
